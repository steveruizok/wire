...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/Wire.ts");
/******/ })
/************************************************************************/
/******/ ({
...
const _ = __webpack_require__(/*! lodash */ "./node_modules/lodash/lodash.js");
const uuid_1 = __webpack_require__(/*! uuid */ "./node_modules/uuid/index.js");
const Pin_1 = __webpack_require__(/*! ./Pin */ "./src/Pin.ts");
const Store_1 = __webpack_require__(/*! ./Store */ "./src/Store.ts");
...
const _ = __webpack_require__(/*! lodash */ "./node_modules/lodash/lodash.js");
const uuid_1 = __webpack_require__(/*! uuid */ "./node_modules/uuid/index.js");
const PinTypes_1 = __webpack_require__(/*! ./misc/PinTypes */ "./src/misc/PinTypes.ts");
class Pin extends EventEmitter {
    ...
    validateValue(value) {
        ...
        switch (this.valueType) {
            case PinTypes_1.default.STRING:
                validator = _.isString;
                break;
            case PinTypes_1.default.NUMBER:
                validator = _.isNumber;
                break;
            case PinTypes_1.default.BOOLEAN:
                validator = _.isBoolean;
                break;
            case PinTypes_1.default.OBJECT:
                validator = _.isObject;
                break;
            case PinTypes_1.default.FUNCTION:
                validator = _.isFunction;
                break;
            case PinTypes_1.default.EVENT:
