...
class Node extends EventEmitter {
    ...
    addRepeatableInputPin() {
        if (this.repeatableInputPin) {
            this.inputPins.push(new Pin_1.default(this.repeatableInputPin, this, true, this.inputPins.length - 1));
        }
    }
    onConnectionAdded() {
        this.compute ? this.compute(this.inputPins, this.outputPins) : null;
...
const _ = __webpack_require__(/*! lodash */ "./node_modules/lodash/lodash.js");
const uuid_1 = __webpack_require__(/*! uuid */ "./node_modules/uuid/index.js");
const ValueTypes_1 = __webpack_require__(/*! ./misc/ValueTypes */ "./src/misc/ValueTypes.ts");
...
exports.default = {
    ...
    ValueTypes: ValueTypes_1.default
};


/***/ }),

/***/ "./src/misc/ValueTypes.ts":
/*!********************************!*\
  !*** ./src/misc/ValueTypes.ts ***!
  \********************************/
/*! no static exports found */
